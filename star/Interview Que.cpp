...
Sort Colors an array of 0’s 1’s 2’s without using extra space or sorting algo ✅
Repeat and Missing Number (https://www.interviewbit.com/problems/repeat-and-missing-number-array/) forrm equation x-y and x2-y2 ✅
Merge two sorted Arrays without extra space ✅
Kadane’s Algorithm ✅
Merge Overlapping Subintervals ✅
smallest difference pair of two arrays
...
4. Inversion of Array (Using Merge Sort) https://www.interviewbit.com/problems/inversions/ ✅
5. Stock Buy and Sell https://leetcode.com/problems/best-time-to-buy-and-sell-stock/ ✅
6. Rotate Matrix Hint: (take transpose and swap ith with (n-i-1)th col) https://leetcode.com/problems/rotate-image/ ✅

Day3: (Math)
Excel Column Number ✅
Find n^x in log N ✅ and pow(x, n) ✅
...
Detect a cycle and removing loop(two different questions and same concept)  ✅ (for proof refer gfg)
...
https://www.chegg.com/homework-help/questions-and-answers/locations-n-packing-crates-implement-algorithm-find-locations-m-crates-closest-truck-input-q36560724
...
https://leetcode.com/problems/partition-labels/ ✅(based on last pos)
...
25.	 Meeting	Rooms	II	https://www.lintcode.com/problem/meeting-rooms-ii/description ✅
26.	 Alien	Dictionary	https://www.lintcode.com/problem/alien-dictionary/description
...
41.	 All	Nodes	Distance	K	in	Binary	Tree	(https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree) ✅ BFS + HashTable(for parent)
...
48.	 Critical	Connections	in	a	Network	(https://leetcode.com/problems/critical-connections-in-a-network) (articulation bridge) (Tarzan's Algo)
...
13.	 Max	Stack	(https://leetcode.com/problems/max-stack) ✅
14.	 Shortest	Word	Distance	II	(https://leetcode.com/problems/shortest-word-distance-ii)
15.	 Factor	Combinations	https://www.lintcode.com/problem/factor-combinations/description ✅
16.	 Closest	Binary	Search	Tree	Value	II	(https://leetcode.com/problems/closest-binary-search-tree-value-ii)
17.	 Nested	List	Weight	Sum	(https://lintcode.com/problem/nested-list-weight-sum) ✅
18.	 Nested	List	Weight	Sum	II	(https://lintcode.com/problem/nested-list-weight-sum-ii) ✅
19.	 Insert	Delete	GetRandom	O(1)	(https://leetcode.com/problems/insert-delete-getrandom-o1) ✅
20.	 Second	Minimum	Node	In	a	Binary	Tree	(https://leetcode.com/problems/second-minimum-node-in-a-binary-tree) ✅
...
11. Count	of	Smaller	Numbers	After	Self	(https://leetcode.com/problems/count-of-smaller-numbers-after-self) ✅ (do it using BIT, SEGTree, BinarySearch)
12. Longest	Increasing	Path	in	a	Matrix	(https://leetcode.com/problems/longest-increasing-path-in-a-matrix)
13. Longest	Substring	with	At	Most	K	Distinct	Characters(https://lintcode.com/problem/longest-substring-with-at-most-k-distinct-characters) ✅
...
20. Split	Array	Largest	Sum	(https://leetcode.com/problems/split-array-largest-sum) *✅(do Dp Solution)
...
27. Game	(https://leetcode.com/problems/24-game)
...
=================================================FACEBOOK============================================================================================================
1. Divide	Two	Integers	(https://leetcode.com/problems/divide-two-integers) ✅ (log(a/b) = log(a)-log(b))
...
5. Valid	Number	(https://leetcode.com/problems/valid-number)
...
9. Read	N	Characters	Given	Read4	II	-	Call	multiple	times(https://leetcode.com/problems/read-n-characters-given-read4-ii-call-multiple-times)
...
17.Integer	to	English	Words	(https://leetcode.com/problems/integer-to-english-words)
...
21.Sparse	Matrix	Multiplication	(https://leetcode.com/problems/sparse-matrix-multiplication)
...
===================IMPORTANT============================
51. https://www.hackerrank.com/challenges/equal/problem?isFullScreen=true  ✅
52. https://codeforces.com/problemset/problem/91/A  ✅
53. https://leetcode.com/problems/reconstruct-itinerary/  ✅
...
=========================BIT=========================
1. Range Sum Query: https://www.geeksforgeeks.org/range-s... ✅
2. Count Inversion Problem : https://www.geeksforgeeks.org/count-i... ✅
3. Codechef Badshaah: https://www.codechef.com/problems/BAA...
4. SPOJ DQUERY: https://www.spoj.com/problems/DQUERY/
5. SPOJ CTRICK : https://www.spoj.com/problems/CTRICK/

======================== Segment Tree ==================
1. Spoj GSS1: https://www.spoj.com/problems/GSS1/
2. SPOJ GSS3:https://www.spoj.com/problems/GSS3/
3. SPOJ KGSS:https://www.spoj.com/problems/KGSS/
4. SPOJ ANDROUND:https://www.spoj.com/problems/ANDROUND/
5. SPOJ D-QUERY: https://www.spoj.com/problems/DQUERY/
6. SPOJ NICEDAY: https://www.spoj.com/problems/NICEDAY/
8. SPOJ FREQUENT: https://www.spoj.com/problems/DQUERY/
9. SPOJ YODANESS: https://www.spoj.com/problems/YODANESS/
10. CODECHEF JTREE:https://www.codechef.com/problems/JTREE
11. CODECHEF COUNZ:https://www.codechef.com/problems/COUNZ
12. CODECHEF DIVMAC:https://www.codechef.com/SEPT16/probl... 
13. CODECHEF QSET: https://www.codechef.com/problems/QSET
